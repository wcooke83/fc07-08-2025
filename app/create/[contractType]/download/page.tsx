...
const handleDownload = (format: string) => {
  ...
  const performDownload = () => {
    ...
    let content = contractData.content || "Contract content not available"
...
const contractTitle = contractType === 'nda' ? 'Non-Disclosure Agreement (NDA)' : 
              ...
              <div className="space-y-8">
                <div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                          Your contract template has been generated and is ready for download. Choose your preferred format above.
                          Remember to have it reviewed by a qualified attorney before use.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mb-8">
                    {/* PDF Document */}
                    <div className="text-center bg-white dark:bg-black border border-gray-200 dark:border-slate-700 rounded-lg p-6 hover:border-gray-400 dark:hover:border-slate-400 transition-colors flex flex-col">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-amber-700 dark:text-slate-300 mt-1">
                          <strong>This is a template only.</strong> Not a substitute for legal advice. Consult an attorney for legal matters.
                        </p>
                      </div>
                    </div>
                  </div>
